...
public class InvariantTest {
	...
	public static void main(String[] args) throws ParseException {
		...
		roles.add("GM");
		roles.add("GL");
		List<BooleanCondition> assumptions = ConditionParser.parseBooleanConditions(Assumptions.class);
		MonitorProvider mp = new MonitorProviderImpl(km);
		mp.monitorAssumptions(assumptions);

		List<BooleanCondition> activeMonitors = ConditionParser.parseBooleanConditions(GroupMember.class);
		activeMonitors.addAll(ConditionParser.parseBooleanConditions(GroupMember.class));

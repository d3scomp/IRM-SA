 ...
 * <ul>
 *   <li>{@link cz.cuni.mff.d3s.irm.model.runtime.impl.AlternativeImpl#getChildren <em>Children</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AlternativeImpl extends MinimalEObjectImpl.Container implements Alternative {
	 ...
	 * @ordered
	 */
	protected EList<InvariantInstance> children;
	...
	protected EClass eStaticClass() {
		return IRMRuntimePackage.Literals.ALTERNATIVE;
	}
	 ...
	 * @generated
	 */
	public List<InvariantInstance> getChildren() {
		if (children == null) {
			children = new EObjectResolvingEList<InvariantInstance>(InvariantInstance.class, this, IRMRuntimePackage.ALTERNATIVE__CHILDREN);
		}
		return children;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IRMRuntimePackage.ALTERNATIVE__CHILDREN:
				return getChildren();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case IRMRuntimePackage.ALTERNATIVE__CHILDREN:
				getChildren().clear();
				getChildren().addAll((Collection<? extends InvariantInstance>)newValue);
				return;
		}
